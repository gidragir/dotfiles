...
alias dotfiles-sync-cli="sudo -v && ansible-playbook /data/projects/dotfiles/playbooks/setup_user.yml --tags stow && ansible-playbook /data/projects/dotfiles/playbooks/packages.yml --tags cli"
